                ...
                <div className={`column is-7-desktop is-full-touch ${styles.lessonDescription}`}>
                  <article>
                    ...
                    <p>Na cotygodniowej katechezie pragniemy poznawać Pana Boga, aby poznawszy Go coraz bardziej kochać,
                       a&nbsp;kochając chcieć Go naśladować. Poznawanie Pana Boga nie ograniczamy jedynie do dwu kwadransów w&nbsp;tygodniu, ale – zgodnie z&nbsp;zaleceniami bł. Edmunda Bojanowskiego –wychowanie religijne jest ściśle
                ...
                <div className={`column is-7-desktop is-full-touch ${styles.lessonDescription}`}>
                  <article>
                    ...
                    <p>Nauka języka angielskiego w&nbsp;naszym przedszkolu to przede wszystkim świetna zabawa. Przy
                       ...
                       bingo, memory,
                       dobble.</p>
                    <p>Zajęcia prowadzone są w&nbsp;języku angielskim, co sprzyja osłuchaniu się dzieci z&nbsp;akcentem i&nbsp;intonacją języka angielskiego, co w&nbsp;późniejszym okresie przekłada się na lepsze wyniki w&nbsp;nauce
                       języka.</p>
                  </article>
                </div>
              </div>
                ...
                <div className={`column is-7-desktop is-full-touch ${styles.lessonDescription}`}>
                  <article>
                    ...
                    <p>Dzieci w&nbsp;wieku przedszkolnym mają niewyczerpane pokłady energii, dlatego też uwielbiają się
                       ...
                       ćwiczenia przeciwko płaskostopiu, korygują wady postawy a&nbsp;także uczestniczą w&nbsp;ćwiczeniach z&nbsp;elementem
